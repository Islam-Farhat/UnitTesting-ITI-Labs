...
namespace CarsApp
{
    ...
    public class Car
    {
        ...
        private double DecreaseVelocity(double Increment)
        {
            return Velocity - Increment;
        }
        public void Brake()
        {
            ...
            {
                case CarType.Toyota:
                    Velocity = DecreaseVelocity(10);
                    break;
                case CarType.BMW:
                    Velocity = DecreaseVelocity(15);
                    break;
                case CarType.Mercedes:
                    Velocity = DecreaseVelocity(20);
                    break;
                case CarType.Audi:
                    Velocity = DecreaseVelocity(25);
                    break;
                default:
                    throw new NotImplementedException();
            }
